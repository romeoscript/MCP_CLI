...
function createProjectDirectory(targetDir) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs.pathExists(targetDir)];
                case 1:
                    if (_a.sent()) {
                        throw new Error("Directory already exists: ".concat(targetDir));
                    }
...
function writeTemplateFile(targetDir, file) {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, dir, content;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    _a.sent();
                    logger_js_1.logger.success("\u2713 Created ".concat(file.path));
                    return [2 /*return*/];
            }
        });
    });
